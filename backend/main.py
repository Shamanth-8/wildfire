...
# Try to import vision service (Gemini Vision API - no heavy dependencies)
try:
    import gemini_vision_service
    VISION_AVAILABLE = True
    print("Gemini Vision service loaded successfully")
except ImportError as e:
    VISION_AVAILABLE = False
    print(f"Warning: gemini_vision_service not available: {e}")
